...
**OpenStreetMap to SVG Converter for Open Platform Course Design (OPCD)**
    This is a complete re-write of osm2svg_v5.py described earlier.  It is now called osm2svg_v7.py were has v6 was my development code.  It has undergone many changes to it since v5.  First lets review the command line help.
